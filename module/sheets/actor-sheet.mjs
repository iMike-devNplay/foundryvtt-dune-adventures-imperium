 ...
 * @extends {ActorSheet}
 */
 export class DuneActorSheet extends ActorSheet {

    /** @inheritdoc */
    static get defaultOptions() {
      return foundry.utils.mergeObject(super.defaultOptions, {
        classes: ["dune", "sheet", "actor"],
        template: "systems/dune/templates/actor-sheet.html",
        width: 720,
        height: 750,
    ...
    /** @override */
    get template() {
      return `systems/dune/templates/actor/actor-${this.actor.data.type}-sheet.html`;
    }
